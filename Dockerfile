...
RUN apt-get -y update && \
    ...
    mkdir -p /tmp/lftl && \
    curl https://storage.googleapis.com/golang/go1.19.5.linux-amd64.tar.gz -o /tmp/lftl/go1.19.5.linux-amd64.tar.gz && \
    tar zxpvf /tmp/lftl/go1.19.5.linux-amd64.tar.gz -C /usr/local && \
    cd /tmp/lftl && \
